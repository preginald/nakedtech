...
const routeDefinitions = [
  { path: '/guides/', sources: ['src/guides.njk', 'src/_data/guideLibrary.js', 'src/_data/searchContent.js'] },
  { path: '/guides/printer-not-printing-first-checks/', sources: ['src/guides/printer-not-printing-first-checks.njk', 'src/_includes/components/editorial/macros.njk', 'src/_includes/components/editorial/styles.css', 'src/_includes/components/editorial/contents.js'] },
  { path: '/guides/check-stuck-print-queue/', sources: ['src/guides/check-stuck-print-queue.njk', 'src/_includes/components/editorial/macros.njk', 'src/_includes/components/editorial/styles.css', 'src/_includes/components/editorial/contents.js'] },
  { path: '/guides/printer-prints-but-will-not-scan/', sources: ['src/guides/printer-prints-but-will-not-scan.njk', 'src/_includes/components/editorial/macros.njk', 'src/_includes/components/editorial/styles.css', 'src/_includes/components/editorial/contents.js'] },
  { path: '/guides/set-up-new-home-printer/', sources: ['src/guides/set-up-new-home-printer.njk', 'src/_includes/components/editorial/macros.njk', 'src/_includes/components/editorial/styles.css', 'src/_includes/components/editorial/contents.js'] },
  { path: '/guides/prepare-new-printer-setup/', sources: ['src/guides/prepare-new-printer-setup.njk', 'src/_includes/components/editorial/macros.njk', 'src/_includes/components/editorial/styles.css', 'src/_includes/components/editorial/contents.js'] },
  { path: '/guides/test-new-printer-and-scanner/', sources: ['src/guides/test-new-printer-and-scanner.njk', 'src/_includes/components/editorial/macros.njk', 'src/_includes/components/editorial/styles.css', 'src/_includes/components/editorial/contents.js'] },
  { path: '/guides/start-using-password-manager/', sources: ['src/guides/start-using-password-manager.njk', 'src/_includes/components/editorial/macros.njk', 'src/_includes/components/editorial/styles.css', 'src/_includes/components/editorial/contents.js'] },
  { path: '/guides/move-passwords-without-losing-access/', sources: ['src/guides/move-passwords-without-losing-access.njk', 'src/_includes/components/editorial/macros.njk', 'src/_includes/components/editorial/styles.css', 'src/_includes/components/editorial/contents.js'] },
  { path: '/guides/password-manager-recovery-plan/', sources: ['src/guides/password-manager-recovery-plan.njk', 'src/_includes/components/editorial/macros.njk', 'src/_includes/components/editorial/styles.css', 'src/_includes/components/editorial/contents.js'] },
  { path: '/guides/home-office-technology-setup/', sources: ['src/guides/home-office-technology-setup.njk', 'src/_includes/components/editorial/macros.njk', 'src/_includes/components/editorial/styles.css', 'src/_includes/components/editorial/contents.js'] },
  { path: '/guides/check-monitor-dock-and-cables/', sources: ['src/guides/check-monitor-dock-and-cables.njk', 'src/_includes/components/editorial/macros.njk', 'src/_includes/components/editorial/styles.css', 'src/_includes/components/editorial/contents.js'] },
  { path: '/guides/check-video-call-camera-sound-light/', sources: ['src/guides/check-video-call-camera-sound-light.njk', 'src/_includes/components/editorial/macros.njk', 'src/_includes/components/editorial/styles.css', 'src/_includes/components/editorial/contents.js'] },
