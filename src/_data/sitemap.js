...
const routeDefinitions = [
  ...
  { path: '/guides/connection-test-results/', sources: ['src/guides/connection-test-results.njk'] },
  { path: '/guides/new-computer-handover-checks/', sources: ['src/guides/new-computer-handover-checks.njk'] },
  { path: '/guides/new-windows-computer-move-checklist/', sources: ['src/guides/new-windows-computer-move-checklist.njk'] },
  { path: '/guides/slow-computer-assessment-notes/', sources: ['src/guides/slow-computer-assessment-notes.njk'] },
  { path: '/guides/wifi-coverage-or-internet-service/', sources: ['src/guides/wifi-coverage-or-internet-service.njk'] },
  { path: '/guides/wifi-dropout-diary/', sources: ['src/guides/wifi-dropout-diary.njk'] },
  { path: '/guides/windows-performance-observations/', sources: ['src/guides/windows-performance-observations.njk'] },
