...
const expectedRoutes = [
  '/guides/computer-virus-warning-first-steps/',
  '/guides/stop-fake-virus-popups/',
  '/guides/understand-windows-security-scan/',

  '/guides/email-not-sending-receiving-syncing/',
  '/guides/find-missing-email/',
  '/guides/test-email-sending-and-receiving/',

  '/guides/suspected-scam-first-steps/',
  '/guides/check-account-access-after-a-scam/',
  '/guides/record-a-suspected-scam/',

  '/guides/home-computer-backup/',
  '/guides/external-drive-or-cloud-backup/',
  '/guides/test-a-backup-file-restore/',

  '/guides/moving-to-a-new-windows-computer/',
  '/',
  '/services/',
  '/services/full-strip/',
  '/services/bodyguard/',
...
assert(sitemapEntries.length === 48, 'sitemap: every canonical public URL has a last-modified date')
...
const deviceGuideRoute = '/guides/wifi-one-device-or-all/'
...
for (const slug of remainingGuideSlugs) {
